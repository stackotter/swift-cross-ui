...
public struct ViewContentBuilder {
    ...
    public static func buildBlock<V0: View, V1: View>(_ view0: V0, _ view1: V1) -> ViewContent2<
        V0, V1
    > {
    ...
    public static func buildBlock<V0: View, V1: View, V2: View, V3: View, V4: View, V5: View>(
        ...
        _ view4: V4,
        _ view5: V5
    ) -> ViewContent6<V0, V1, V2, V3, V4, V5> {
    ...
    >(_ view0: V0, _ view1: V1, _ view2: V2, _ view3: V3, _ view4: V4, _ view5: V5, _ view6: V6)
        -> ViewContent7<V0, V1, V2, V3, V4, V5, V6>
    {
        return ViewContent7<V0, V1, V2, V3, V4, V5, V6>(
            view0,
            view1,
            view2,
            view3,
    ...
    >(
        ...
        _ view6: V6,
        _ view7: V7
    ) -> ViewContent8<V0, V1, V2, V3, V4, V5, V6, V7> {
        return ViewContent8<V0, V1, V2, V3, V4, V5, V6, V7>(
            view0,
            view1,
            view2,
            view3,
    ...
    >(
        ...
        _ view7: V7,
        _ view8: V8
    ) -> ViewContent9<V0, V1, V2, V3, V4, V5, V6, V7, V8> {
        return ViewContent9<V0, V1, V2, V3, V4, V5, V6, V7, V8>(
            view0,
            view1,
            view2,
            view3,
    ...
    >(
        ...
        _ view8: V8,
        _ view9: V9
    ) -> ViewContent10<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9> {
        return ViewContent10<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9>(
            view0,
            view1,
            view2,
            view3,
