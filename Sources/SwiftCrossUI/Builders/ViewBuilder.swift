...
public struct ViewBuilder {
    ...
    public static func buildBlock<V0: View, V1: View>(_ view0: V0, _ view1: V1) -> VariadicView2<
        V0, V1
    > {
    ...
    ) -> VariadicView6<V0, V1, V2, V3, V4, V5> {
    ...
    >(_ view0: V0, _ view1: V1, _ view2: V2, _ view3: V3, _ view4: V4, _ view5: V5, _ view6: V6)
        -> VariadicView7<V0, V1, V2, V3, V4, V5, V6>
    {
        return VariadicView7<V0, V1, V2, V3, V4, V5, V6>(
    ...
    >(
        _ view0: V0, _ view1: V1, _ view2: V2, _ view3: V3, _ view4: V4, _ view5: V5, _ view6: V6,
        _ view7: V7
    ) -> VariadicView8<V0, V1, V2, V3, V4, V5, V6, V7> {
        return VariadicView8<V0, V1, V2, V3, V4, V5, V6, V7>(
    ...
    ) -> VariadicView9<V0, V1, V2, V3, V4, V5, V6, V7, V8> {
        return VariadicView9<V0, V1, V2, V3, V4, V5, V6, V7, V8>(
    ...
    ) -> VariadicView10<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9> {
        return VariadicView10<V0, V1, V2, V3, V4, V5, V6, V7, V8, V9>(
