...
addSignal(name: "notify::above-child", handler: gCallback(handler0)) { [weak self] (param0: OpaquePointer) in
...
addSignal(name: "notify::visible-window", handler: gCallback(handler1)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
