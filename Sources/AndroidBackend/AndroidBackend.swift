...
public final class AndroidBackend: AppBackend {
    ...
    public var defaultTableRowContentHeight: Int { 0 }
    ...
    public var defaultToggleStyle: ToggleStyle { .switch }
    public var requiresImageUpdateOnScaleFactorChange: Bool { false }
    public var menuImplementationStyle: MenuImplementationStyle { .menuButton }
