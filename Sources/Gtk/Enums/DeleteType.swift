...
public enum DeleteType {
    /// Delete characters.
    case characters
    /// Delete only the portion of the word to the left/right of cursor if we’re in the middle of a
    /// word.
    case wordEnds
    /// Delete words.
    case words
    /// Delete display-lines. Display-lines refers to the visible lines, with respect to to the
    /// current line breaks. As opposed to paragraphs, which are defined by line breaks in the
    /// input.
    case displayLines
