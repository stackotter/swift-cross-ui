...
let handler1: @convention(c) (UnsafeMutableRawPointer, GtkMovementStep, Int, Bool, Bool, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, value3, value4, data in
        SignalBox4<GtkMovementStep, Int, Bool, Bool>.run(data, value1, value2, value3, value4)
    }

addSignal(name: "move-cursor", handler: gCallback(handler1)) { [weak self] (param0: GtkMovementStep, param1: Int, param2: Bool, param3: Bool) in
    guard let self = self else { return }
    self.moveCursor?(self, param0, param1, param2, param3)
}

let handler2: @convention(c) (UnsafeMutableRawPointer, UnsafeMutablePointer<GtkListBoxRow>, UnsafeMutableRawPointer) -> Void =
    { _, value1, data in
        SignalBox1<UnsafeMutablePointer<GtkListBoxRow>>.run(data, value1)
    }

addSignal(name: "row-activated", handler: gCallback(handler2)) { [weak self] (param0: UnsafeMutablePointer<GtkListBoxRow>) in
    guard let self = self else { return }
    self.rowActivated?(self, param0)
}

let handler3: @convention(c) (UnsafeMutableRawPointer, UnsafeMutablePointer<GtkListBoxRow>?, UnsafeMutableRawPointer) -> Void =
    { _, value1, data in
        SignalBox1<UnsafeMutablePointer<GtkListBoxRow>?>.run(data, value1)
    }

addSignal(name: "row-selected", handler: gCallback(handler3)) { [weak self] (param0: UnsafeMutablePointer<GtkListBoxRow>?) in
    guard let self = self else { return }
...
addSignal(name: "notify::accept-unpaired-release", handler: gCallback(handler6)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::activate-on-single-click", handler: gCallback(handler7)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::selection-mode", handler: gCallback(handler8)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::show-separators", handler: gCallback(handler9)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::tab-behavior", handler: gCallback(handler10)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
