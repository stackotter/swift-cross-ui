...
addSignal(name: "notify::enable-search", handler: gCallback(handler1)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::expression", handler: gCallback(handler2)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::factory", handler: gCallback(handler3)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::header-factory", handler: gCallback(handler4)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::list-factory", handler: gCallback(handler5)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::model", handler: gCallback(handler6)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::search-match-mode", handler: gCallback(handler7)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::selected", handler: gCallback(handler8)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::selected-item", handler: gCallback(handler9)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::show-arrow", handler: gCallback(handler10)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
