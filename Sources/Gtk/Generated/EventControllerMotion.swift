...
public convenience init() {
    ...
    let handler0: @convention(c) (UnsafeMutableRawPointer, Double, Double, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, data in
        SignalBox2<Double, Double>.run(data, value1, value2)
    }

addSignal(name: "enter", handler: gCallback(handler0)) { [weak self] (param0: Double, param1: Double) in
...
let handler2: @convention(c) (UnsafeMutableRawPointer, Double, Double, UnsafeMutableRawPointer) -> Void =
    { _, value1, value2, data in
        SignalBox2<Double, Double>.run(data, value1, value2)
    }

addSignal(name: "motion", handler: gCallback(handler2)) { [weak self] (param0: Double, param1: Double) in
    guard let self = self else { return }
...
addSignal(name: "notify::contains-pointer", handler: gCallback(handler3)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
...
addSignal(name: "notify::is-pointer", handler: gCallback(handler4)) { [weak self] (param0: OpaquePointer) in
    guard let self = self else { return }
